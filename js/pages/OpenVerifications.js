...
import { fetchEditors, fetchOpenVerifications } from "../content.js";
            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    ...
                    <ul class="stats">
                        ...
                        <li>
                            <div class="type-title-sm">Estimated placement</div>
                            <p>{{ level.est }}</p>
                        </li>
                    </ul>
                    <h2>Records</h2>
...
async mounted() {
    ...
    if (!this.list) {
        this.errors = [
            "Failed to load open verification list. Retry in a few minutes or notify list staff.",
        ];
    } else {
        this.errors.push(
            ...this.list
